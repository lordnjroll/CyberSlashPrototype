...
public class mesh_destroy : MonoBehaviour
{
	...
	public bool hit;
	public float forceToExplode = 1f;
	
	[Header("Generation Settings")]
	[SerializeField] private int generation = 1;
	[SerializeField] private int maxGeneration = 6;
	
	[Header("Explode Settings")]
    [SerializeField] private int cutPerHit = 2;
    ...
    void Update()
    {
		...
		{
			Destroy(this.gameObject, UnityEngine.Random.Range(10, 30));
		}
    }
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(mesh_destroy original)
        {
			...
			meshDestroy.forceToExplode = original.forceToExplode;
			meshDestroy.generation = original.generation + 1;
			meshDestroy.maxGeneration = original.maxGeneration;
			meshDestroy.cutPerHit = original.cutPerHit;
